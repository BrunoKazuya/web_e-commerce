...
const ProductCart = ({ product, onQuantityChange, onRemoveProduct }) => {
  ...
  return (
    <li className="py-6">
      <div
        className={`flex items-center py-5 border border-gray-200 flex-col sm:flex-row rounded-lg p-3 ${
          quantity === 0 ? "bg-gray-100" : ""
        }`}
      >
        ...
        <div className="ml-4 flex flex-1 flex-col">
          ...
          <p className="fw-light text-sm text-gray-500">
          ...
          <div className="flex flex-1 items-end justify-between text-sm mt-2">
            ...
            <button
              className="text-red-500 hover:text-red-600 text-sm flex items-center hover:bg-gray-200 p-2 rounded-lg cursor-pointer"
