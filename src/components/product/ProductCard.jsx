  ...
  return (
    <div className="rounded-3xl border border-gray-200 bg-white">
      ...
      <div className="p-2.5 space-y-2.5">
        ...
        <p className="text-lg font-bold">R$ {info.price.toLocaleString("pt-BR", {
      ...
      <div className="flex justify-evenly items-center py-5 px-2.5">
        ...
        <button
          className="bg-blue-600 text-white rounded-xl py-2.5 px-5 text-sm hover:bg-blue-500 flex items-center cursor-pointer"
          onClick={() => cart()}
        >
