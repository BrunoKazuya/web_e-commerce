          ...
          <li key={addr.id} className="mb-6">
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-1">
                <div>
                  <Label className="font-bold" htmlFor="zipCode">CEP</Label>
                  <p>{addr.cep}</p>
                </div>
                <div>
                  <Label className="font-bold" htmlFor="street">Rua</Label>
                  <p>{street}</p>
                </div>
                <div>
                  <Label className="font-bold" htmlFor="number">Número</Label>
                  <p>{number}</p>
                </div>
                <div>
                  <Label className="font-bold" htmlFor="neighborhood">Bairro</Label>
                  <p>{neighborhood}</p>
                </div>
                <div>
