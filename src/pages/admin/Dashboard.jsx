...
const Dashboard = () => {
  ...
  const recentOrders = [
    { id: '12345', total: 'R$ 120,00', status: 'Concluído', date: '01/05/2025' },
    { id: '12346', total: 'R$ 85,50', status: 'Processando', date: '30/04/2025' },
    { id: '12347', total: 'R$ 230,10', status: 'Concluído', date: '28/04/2025' },
        ...
        <Card className="border border-gray-200 p-5 rounded-lg">
          ...
          <Box>
            <div className="h-80 flex items-center justify-center bg-slate-50 rounded-lg">
              ...
              <span className="ml-2 text-slate-500">Gráfico aparecerá aqui</span>
            </div>
          </Box>
        </Card>
        ...
        <Card className="border border-gray-200 p-5 rounded-lg">
          <div className="flex flex-row items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500">Pedidos mais recentes dos clientes</p>
            </div>
